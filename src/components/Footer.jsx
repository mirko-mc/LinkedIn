                ...
                <Row className="bg-dark">
                    <Col sm={12} md={5}>
                        <div className="d-flex">
                            <ul className="list-style-type:none  text-white mt-5 p-4 text-center">
                    ...
                    <Col className="align-self-center text-white" sm={12} md={5}>
                        <div >
                            ...
                            <div className="d-flex">
                                ...
                                <div>
                                    <h4>Gestisci il tuo account e la tua privacy</h4>
                            ...
                            <div className="d-flex">
                                ...
                                <div>
                                    <h4>Trasparenza sui contenuti consigliati</h4>
                                    <h6>Scopri di più sui contenuti cosigliati</h6>
                                </div>
                            </div>
                        </div>
